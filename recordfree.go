...
func loadFreeRecords(recordsFilename string) ([]shouldwater.WeatherRecord, error) {
	...
	var records []shouldwater.WeatherRecord
	...
	for i, row := range rows {
		...
		records = append(records, shouldwater.WeatherRecord{
			Timestamp: timestamp,
